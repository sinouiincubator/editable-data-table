...
- 内置继承了[useSimpleEditingList](https://sinouiincubator.github.io/editable-data-table/components-api#usesimpleeditinglist020)的方法和属性,
  区别就是`useSimpleEditingList`的增删改方法不与后端交互，而`useEditingList`的增删改查均与后端交互，除此之外还有排序等功能。
